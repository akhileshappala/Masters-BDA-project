...
class RefHolder extends _react.default.Component {
  render() {
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== 'function' ? _react.default.Children.only(children).props : {};
  const getTarget = (0, _react.useCallback)(() => (0, _safeFindDOMNode.default)(triggerNodeRef.current), []);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [typeof children === 'function' ? children({
      ...triggerProps,
      ref: triggerNodeRef
    }) : /*#__PURE__*/(0, _jsxRuntime.jsx)(RefHolder, {
      ref: triggerNodeRef,
      children: /*#__PURE__*/(0, _react.cloneElement)(children, triggerProps)
