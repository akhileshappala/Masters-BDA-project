...
function useAccordionToggle(eventKey, onClick) {
  const contextEventKey = (0, _react.useContext)(_AccordionContext.default);
  const onSelect = (0, _react.useContext)(_SelectableContext.default);
  return e => {
    /*
...
const AccordionToggle = /*#__PURE__*/_react.default.forwardRef(({
