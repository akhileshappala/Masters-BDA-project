 ...
 */
import { CellProps, DefaultSortTypes, FilterProps, Filters, FilterValue, HeaderProps, IdType, Renderer, SortByFn, UseFiltersColumnProps, UseResizeColumnsColumnProps, UseSortByColumnProps } from 'react-table';
...
export type DataTableFilterProps<T extends Record<string, unknown>> = FilterProps<T> & {
 ...
 */
export type DataTableColumn<T extends Record<string, unknown>> = ColumnBasicOptions<T> & ColumnFilterOptions<T> & ColumnResizeOptions & ColumnDragDropOptions & ColumnSortOptions<T>;
export type DataTableColumnInstance<T extends Record<string, unknown>> = UseFiltersColumnProps<T> & UseResizeColumnsColumnProps<T> & UseFlexLayoutColumnPropsCustom<T> & UseSortByColumnProps<T>;
export {};
