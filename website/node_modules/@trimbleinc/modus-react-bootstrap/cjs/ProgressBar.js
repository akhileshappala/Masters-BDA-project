...
function onlyProgressBar(props, propName, componentName) {
  ...
  _react.default.Children.forEach(children, child => {
    ...
    const childIdentifier = /*#__PURE__*/_react.default.isValidElement(child) ? childType.displayName || childType.name || childType : child;
...
const ProgressBar = /*#__PURE__*/_react.default.forwardRef(({
  isChild,
  ...props
}, ref) => {
