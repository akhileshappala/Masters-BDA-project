...
function useTabContext(props) {
  ...
  const key = (0, _SelectableContext.makeEventKey)(props.eventKey);
  return {
    ...props,
...
const TabPane = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  const {
    bsPrefix,
    className,
    active,
  ...
  let pane = /*#__PURE__*/(0, _jsxRuntime.jsx)(Component, {
    ...rest,
    ref: ref,
    role: "tabpanel",
    "aria-hidden": !active,
  ...
  if (Transition) pane = /*#__PURE__*/(0, _jsxRuntime.jsx)(Transition, {
    in: active,
    onEnter: onEnter,
