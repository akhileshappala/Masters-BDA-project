...
function Overlay({
  ...
  const [ref, marginModifiers] = (0, _usePopperMarginModifiers.default)();
  const actualTransition = transition === true ? _Fade.default : transition || null;
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Overlay.default, {
    ...
    children: ({
      ...
      return /*#__PURE__*/_react.default.cloneElement(overlay, {
        ...props,
        ...overlayProps,
        placement,
        arrowProps,
