...
// Modus JavaScript for menu control
// Doc ready function from: https://github.com/jfriend00/docReady
...
(function () {
  ...
  window.docReady(function () {
    // code here
    console.log("Modus JS Loaded");
    const menuButtons = document.querySelectorAll("[data-modus-item='menu-btn']");

    if (menuButtons) {
      Array.from(menuButtons).forEach(el => {
        el.addEventListener("click", e => {
          sidebar_toggle(e.target);
        });
      });
    }
    ...
    function sidebar_toggle(element) {
      var body = findAncestor(element, ".modus-layout").querySelector("[data-modus-item='body']");
